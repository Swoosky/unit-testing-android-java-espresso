...
public class AddEditActivityTest0193 {
        ...
        ViewInteraction textInputEditText = onView(
                allOf(withId(R.id.et_nama),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText.perform(replaceText("Agus Putra Hendrawan"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText4 = onView(
                allOf(withId(R.id.et_npm), withText("19"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText4.perform(replaceText("190710193"));

        ViewInteraction textInputEditText5 = onView(
                allOf(withId(R.id.et_npm), withText("190710193"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.layout_npm),
                                        0),
        ...
        ViewInteraction textInputEditText7 = onView(
                allOf(withId(R.id.et_npm), withText("190710193"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText7.perform(replaceText("1907101933"));

        ViewInteraction textInputEditText8 = onView(
                allOf(withId(R.id.et_npm), withText("1907101933"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.layout_npm),
                                        0),
        ...
        ViewInteraction textInputEditText10 = onView(
                allOf(withId(R.id.et_npm), withText("1907101933"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText10.perform(replaceText("190710193"));
        ...
        ViewInteraction textInputEditText13 = onView(
                allOf(withId(R.id.et_npm), withText("190710193"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText13.perform(replaceText("230710193"));

        ViewInteraction textInputEditText14 = onView(
                allOf(withId(R.id.et_npm), withText("230710193"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.layout_npm),
                                        0),
